...
class QCard extends StatefulWidget {
  const QCard({Key? key, required this.ques, required this.callBack})
      : super(key: key);
...
class _QCardState extends State<QCard> {
  ...
  void setAnswer(){
    DiabeticQuestions.sampleQuiz1[widget.ques.qno-1].defaultValue = _currentValue; 
  }
            ...
            children: [
              Row(
                ...
                children: [
                  ...
                  const Text(" of "),
                  Text(DiabeticQuestions.sampleQuiz1.length.toString())
                ],
              ),
              const SizedBox(
                height: 20,
              ...
              widget.ques.qno == DiabeticQuestions.sampleQuiz1.length ?
              Padding(
