...
class QCard1 extends StatefulWidget {
  const QCard1({Key? key, required this.ques, required this.callBack})
      : super(key: key);
  final DiabetesQues ques;
  final Function() callBack;

  @override
  State<QCard1> createState() => _QCardState();
}

class _QCardState extends State<QCard1> {
  double _currentValue = 0;

  void setAnswer(){
    DiabeticQuestions.sampleQuiz2[widget.ques.qno-1].defaultValue = _currentValue; 
  }
            ...
            children: [
              Row(
                ...
                children: [
                  ...
                  const Text(" of "),
                  Text(DiabeticQuestions.sampleQuiz2.length.toString())
                ],
              ),
              const SizedBox(
                height: 20,
